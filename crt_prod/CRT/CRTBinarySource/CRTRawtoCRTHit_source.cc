...
private:
  ...
  //  std::vector<BernZMQBinaryInputStreamReader> fStreamReaders; //No IDEA
  //std::vector<crt::CRTHit> fStreamReaders; //No IDEA
  std::vector<std::ifstream>                  fInputStreams;
  std::vector<art::Timestamp>                 fInputStreamLastPullTime;
  
  //void writeEvent(std::vector<crt::CRTHit> & v_crt, art::RunPrincipal const* const, art::SubRunPrincipal const* const,
